...
require_once(dirname(__FILE__).'/Plugin_Name_Admin_Base.php');
 
class Plugin_Name_Admin extends Plugin_Name_Admin_Base{
        ...
        private function __construct() {
                ...
                $this->sections['general']                   = __( 'Main Settings', $this->plugin_slug );
                $this->sections['styling']                  = __( 'Styling', $this->plugin_slug );
                $this->sections['display_rules']        	= __( 'Display Rules', $this->plugin_slug );
                $this->sections['debugging']                = __( 'Debugging', $this->plugin_slug );
